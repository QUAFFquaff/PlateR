...
namespace easypr {
  ...
  static const char* kDefaultSvmPath = "E:/QT/PlateR/model/svm_hist.xml";//绝对路径 C:\Qt\Qt5.3.0\PlateR\PlateR\model\svm_hist.xml
  static const char* kLBPSvmPath = "E:/QT/PlateR/model/svm_lbp.xml";
  static const char* kHistSvmPath = "E:/QT/PlateR/model/svm_hist.xml";

  static const char* kDefaultAnnPath = "E:/QT/PlateR/model/ann.xml";
  static const char* kChineseAnnPath = "E:/QT/PlateR/model/ann_chinese.xml";
  static const char* kGrayAnnPath = "E:/QT/PlateR/model/annCh.xml";

//  //This is important to for key transform to chinese
static const char* kChineseMappingPath = "E:/QT/PlateR/model/province_mapping";
